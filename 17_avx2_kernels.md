...
性能差が維持されているのは、効率的なマイクロカーネル（特に4x12）が、キャッシュから溢れても優れたプリフェッチとデータ局所性を提供しているためです。

Threadripperのように複雑なキャッシュ階層と高いメモリ帯域幅を持つCPUでは、マイクロカーネルの選択が全体のパフォーマンスに大きく影響し、最適化における重要な要素となっています。

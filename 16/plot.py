...
def read_and_plot_csv(main_csv="dgemm_benchmark_avx_block_kernel_results.csv", 
                     comparison_csv=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--main', default='dgemm_benchmark_avx_block_kernel_results.csv',
                        help='Main CSV file to plot (automatically uses dgemm_benchmark_avx_block_kernel_results.csv if not specified)')

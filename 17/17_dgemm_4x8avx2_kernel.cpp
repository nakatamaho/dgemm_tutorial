...
// 4x8 micro kernel (using AVX2) - B transposed version
void avx2_micro_kernel_4x8_aligned(int k,
...
// DGEMM implementation using 4x8 micro kernel with transposed B panel, using L3 cache blocking
...
int main(int argc, char *argv[]) {
    ...
    std::ofstream csv_file("dgemm_benchmark_4x8avx2_kernel_results.csv");
    ...
    csv_file.close();
    std::cout << "Benchmark complete. Results saved to dgemm_benchmark_4x8avx2_kernel_results.csv" << std::endl;

...
g++ -O3 -march=znver2 -mtune=znver2 -ffast-math -funroll-loops -flto 17_dgemm_4x12avx2_kernel.2.cpp -o 17_dgemm_4x12avx2_kernel.2 ; ./17_dgemm_4x12avx2_kernel.2  --nocheck

...
int main(int argc, char *argv[]) {
    ...
    std::ofstream csv_file("dgemm_benchmark_4x4avx2_kernel_results.csv");
    ...
    csv_file.close();
    std::cout << "Benchmark complete. Results saved to dgemm_benchmark_4x4avx2_kernel_results.csv" << std::endl;

...
int main(int argc, char *argv[]) {
    ...
    std::ofstream csv_file("dgemm_benchmark_4x12avx2_NKM_openmp_kernel.csv");
    ...
    csv_file.close();
    std::cout << "Benchmark complete. Results saved to dgemm_benchmark_4x12avx2_NKM_openmp_kernel.csv" << std::endl;

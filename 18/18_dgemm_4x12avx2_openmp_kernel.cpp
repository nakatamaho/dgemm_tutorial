...
void avx2_micro_kernel_4x12_aligned(int k,
    ...
    for (int l = 0; l < k; ++l) {
        ...
        // Broadcast each of the 12 B-elements from row l
...
#pragma omp parallel for collapse(2) num_threads(NUMOFTHREADS)
...
int main(int argc, char *argv[]) {
    ...
    std::ofstream csv_file("dgemm_benchmark_4x12avx2_kernel_results.csv");
    ...
    csv_file.close();
    std::cout << "Benchmark complete. Results saved to dgemm_benchmark_4x12avx2_kernel_results.csv" << std::endl;

...
**実況・山田＆解説・似鳥**
(同じ名前の別の方は二人ともプロ中のプロとして有名です。ただこの解説とは関係ありません)
...
![DGEMM ベンチマークプロット](16/dgemm_benchmark_comparison_plot.png)
 ...
 - **そこそこ良いパフォーマンス**: 今回は、最大で26.5GFlopsでました。Ryzen3970Xの１コアでの理論性能値は59.2GFLOPS～72GFLOPSなので、少々パフォーマンスが出ていません。カーネルのパラメータのチューニングが必要なようです。

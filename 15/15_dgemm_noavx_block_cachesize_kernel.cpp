...
int main(int argc, char *argv[]) {
    ...
    std::ofstream csv_file("dgemm_benchmark_noavx_block_cachesize_kernel_results.csv");
    ...
    csv_file.close();
    std::cout << "Benchmark complete. Results saved to dgemm_benchmark_noavx_block_cachesize_kernel_results.csv" << std::endl;
